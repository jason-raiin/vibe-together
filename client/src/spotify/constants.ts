...
export const LOGIN_URL_PARAMS1 = `${SPOTIFY_LOGIN_URL}?client_id=${CLIENT_ID}&response_type=code&redirect_uri=${REDIRECT_URI}`;
export const LOGIN_URL_PARAMS2 = `&scope=user-top-read`;
